...
{
    public class GoodsTypeController : Web.Controllers.AdminBaseController
    {
        // GET: Admin_BasicSettings/GoodsType
        ...
        {
            return Json(DB.Sys_BasicData.Save(DataBase, Convert.ToInt32(Common.SysDictionary.BasicType.Goods)));
        }
