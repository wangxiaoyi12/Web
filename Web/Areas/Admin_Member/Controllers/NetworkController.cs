...
namespace Web.Areas.Admin_Member.Controllers
{
    ...
    /// 网络图
    /// </summary>
    public class NetworkController : Web.Controllers.AdminBaseController
    {
        public ActionResult Index()
        {
            ViewBag.TopCode = "admin";
            return View();
        }
        ...
        public ActionResult Index2(string id)
        {
            ...
            {
                var admin = DB.Member_Info.FindEntity(a => a.Code == "admin");
                id = admin.MemberId;
            }
            //查询会员，使用上下级查询
        ...
        {
            var m = DB.Member_Info.FindEntity(a => a.Code == id);
            if (m != null)
            {
                return ControllerPath + "/Index2/" + m.MemberId;
            }
            else
            {
                return "";
        ...
        {
            var regUrl = "/Admin_Member/FormalMember/Insert";
