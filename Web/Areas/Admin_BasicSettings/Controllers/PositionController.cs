...
{
    public class PositionController : Web.Controllers.AdminBaseController
    {
        // GET: Admin_BasicSettings/Position
        private string type = "岗位";
        ...
        {
            return Json(DB.Sys_BasicData.Save(DataBase, Convert.ToInt32(Common.SysDictionary.BasicType.Position)));
        }
