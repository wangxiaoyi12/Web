...
namespace Common
{
    ...
    public static class DatabaseExtensions
    {
        ...
        private static IDbConnection DefaultConnection
        {
            get
            {
                return DataBase.MyConfig.DefaultConnection;
            }
        }
        /// <summary>
        ...
        private static string DefaultConnectionString
        {
            get
            {
                return DataBase.MyConfig.DefaultConnectionString;
            }
        }
        /// <summary>
        /// 动态查询主方法
        ...
        public static string SqlQueryForJson(this Database db, string sql, params object[] parameters)
        {
            ...
            var result= Common.JsonConverter.ToJson(dataReader);
